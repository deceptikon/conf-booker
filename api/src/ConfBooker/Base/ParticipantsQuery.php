...
abstract class ParticipantsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ConfBooker\Base\ParticipantsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'conf_booker_db', $modelName = '\\ConfBooker\\Participants', $modelAlias = null)
    {
