...
/**
 * Base class that represents a row from the 'specialities' table.
 *
 *
 *
 * @package    propel.generator.ConfBooker.Base
 */
abstract class Specialities implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ConfBooker\\Map\\SpecialitiesTableMap';
    ...
    /**
     * Initializes internal state of ConfBooker\Base\Specialities object.
     */
    ...
    /**
     * Compares this with another <code>Specialities</code> instance.  If
     * <code>obj</code> is an instance of <code>Specialities</code>, delegates to
     * <code>equals(Specialities)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Specialities The current object, for fluid interface
     */
     ...
     * @return $this|\ConfBooker\Specialities The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SpecialitiesTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[SpecialitiesTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpecialitiesTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpecialitiesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = SpecialitiesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ConfBooker\\Specialities'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSpecialitiesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Specialities::setDeleted()
     * @see Specialities::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpecialitiesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SpecialitiesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[SpecialitiesTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SpecialitiesTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(SpecialitiesTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(SpecialitiesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `specialities` (%s) VALUES (%s)',
    ...
    {
        $pos = SpecialitiesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Specialities'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Specialities'][$this->hashCode()] = true;
        $keys = SpecialitiesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ConfBooker\Specialities
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ConfBooker\Specialities The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(SpecialitiesTableMap::DATABASE_NAME);

        if ($this->isColumnModified(SpecialitiesTableMap::COL_ID)) {
            $criteria->add(SpecialitiesTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(SpecialitiesTableMap::COL_NAME)) {
            $criteria->add(SpecialitiesTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildSpecialitiesQuery::create();
        $criteria->add(SpecialitiesTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ConfBooker\Specialities (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ConfBooker\Specialities Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildSpecialities is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpecialities The current object (for fluent API support)
     */
    public function setUserSpecialities(Collection $userSpecialities, ConnectionInterface $con = null)
    {
        ...
        foreach ($userSpecialitiesToDelete as $userSpecialityRemoved) {
            $userSpecialityRemoved->setSpecialities(null);
        }
    ...
    protected function doAddUserSpeciality(ChildUserSpeciality $userSpeciality)
    {
        ...
        $userSpeciality->setSpecialities($this);
    }
    ...
    public function removeUserSpeciality(ChildUserSpeciality $userSpeciality)
    {
        if ($this->getUserSpecialities()->contains($userSpeciality)) {
            ...
            $userSpeciality->setSpecialities(null);
        }
     ...
     * Otherwise if this Specialities is new, it will return
     * an empty collection; or if this Specialities has previously
     * been saved, it will retrieve related UserSpecialities from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Specialities.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildUserSpeciality[] List of ChildUserSpeciality objects
     */
    public function getUserSpecialitiesJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserSpecialityQuery::create(null, $criteria);
    ...
    public function initUsers()
    {
        ...
        $this->collUsers->setModel('\ConfBooker\User');
    }
     ...
     * @return ChildSpecialities The current object (for fluent API support)
     */
    ...
    protected function doAddUser(ChildUser $user)
    {
        ...
        if (!$user->isSpecialitiessLoaded()) {
            $user->initSpecialitiess();
            $user->getSpecialitiess()->push($this);
        } elseif (!$user->getSpecialitiess()->contains($this)) {
            $user->getSpecialitiess()->push($this);
        }
    ...
    public function removeUser(ChildUser $user)
    {
        if ($this->getUsers()->contains($user)) {
            ...
            if ($user->isSpecialitiessLoaded()) {
                ...
                $user->getSpecialitiess()->removeObject($this);
            }
    ...
    {
        return (string) $this->exportTo(SpecialitiesTableMap::DEFAULT_STRING_FORMAT);
    }
